...
window.addEventListener('scroll', function() {
	...
	if (schedulePos < viewportHeight / 2) {
		if (vw > 600) { // for desktop and tablet
			photoSchedule1.style.transform = 'translate(0vw, 0vw) rotate(6deg)';
		} else { // for mobile
			photoSchedule1.style.transform = 'translate(-10px, 0px) rotate(6deg)';
		}
	}
	...
	if (travelPos < viewportHeight / 2) {
		if (vw > 900) { // for desktop
			...
			photoTravel1.style.transform = 'translate(-150px, 70px) rotate(6deg)';
			photoTravel2.style.transform = 'translate(150px, 0px) rotate(-6deg)';
		}
	}
	...
	if (todoPos < viewportHeight / 2) {
		if (vw > 900) { // for desktop
			...
			photoTodo1.style.transform = 'translate(-150px, 0px) rotate(-6deg)';
			photoTodo2.style.transform = 'translate(150px, 70px) rotate(6deg)';
		}
	}
